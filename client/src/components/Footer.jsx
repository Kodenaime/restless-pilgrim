      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Welcome to our spiritual journey together. Here you'll find inspiring devotionals, 
              meaningful books, and uplifting content to strengthen your faith and encourage your walk with God.
            </p>
            {/* Social Media Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/devotionals" className="text-gray-300 hover:text-white transition-colors">
                  Devotionals
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/playlist" className="text-gray-300 hover:text-white transition-colors">
                  Playlist
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} The Restless Pilgrim. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
